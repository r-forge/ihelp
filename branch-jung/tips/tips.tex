...
본 페이지는 다양한 종류의 패키지들을 활용하는 방법보다는 \uline{R 기본 시스템만을 활용하여 할 수 있는 내용들만이 정리되어 집니다}. 
...
위와 같은 데이터를 아래와 같이 자동으로 채워주려면 어떻게 해야 할까요? 	
...
\item SAS에서처럼 .FIRST 와 .LAST 같은 것들이 R로 할 수 있나요? 
